...
class PF_Flags_Table extends WP_List_Table {
    ...
    function column_name($item) {
        //Build row actions
        $actions = array(
            'edit'      => sprintf('<a href="?page=%s&action=%s&flag=%s">Edit</a>',$_REQUEST['page'],'edit',$item['id']),
            'delete'    => sprintf('<a href="?page=%s&action=%s&flag=%s">Delete</a>',$_REQUEST['page'],'delete',$item['id']),
        );
